export const dataMenu = [
  ...
  },
  {
    key: '3',
    name: 'Enterprise',
    description: 'The Enterprise is the highest level in a modeling hierarchy. It can represent the company itself or a large division within the company. An enterprise can contain one or more factories.',
    link: '/enterprise',
    img: 'https://cdn-icons-png.freepik.com/512/4102/4102762.png'
  },
  {
    key: '4',
    name: 'Resource',
